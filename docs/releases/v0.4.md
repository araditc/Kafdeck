...
The v0.4 candidate must pass exact-head quality/security/compatibility/readiness evidence and protected-main governance. The candidate manifest is stored separately in `.github/release/v0.4-candidate.json`; the active publication manifest remains v0.3 until a separate explicit owner release decision. Tag/publication are not armed before that approval.
