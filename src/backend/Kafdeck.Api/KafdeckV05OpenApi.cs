    ...
    public const string Document = """
{
  ...
  "paths": {
    ...
    "/api/v1/mutations/{operationId}/approve": { "$ref": "#/components/pathItems/ReviewAction" },
    "/api/v1/mutations/{operationId}/reject": { "$ref": "#/components/pathItems/ReviewAction" },
    ...
    "/api/v1/mutations/{operationId}/execute": { "$ref": "#/components/pathItems/ExecuteWithoutMaterial" },

    "/api/v1/clusters/{clusterId}/topics/{topicName}/mutations/create/preview": { "$ref": "#/components/pathItems/TopicCreatePreview" },
    "/api/v1/clusters/{clusterId}/topics/{topicName}/mutations/alter/preview": { "$ref": "#/components/pathItems/TopicAlterPreview" },
    "/api/v1/clusters/{clusterId}/topics/{topicName}/mutations/increase-partitions/preview": { "$ref": "#/components/pathItems/TopicIncreasePartitionsPreview" },
    "/api/v1/clusters/{clusterId}/topics/{topicName}/mutations/delete/preview": { "$ref": "#/components/pathItems/TopicDeletePreview" },
    ...
    "/api/v1/clusters/{clusterId}/consumer-groups/{groupId}/mutations/offsets/preview": { "$ref": "#/components/pathItems/ConsumerOffsetPreview" },
    "/api/v1/clusters/{clusterId}/consumer-groups/{groupId}/mutations/delete/preview": { "$ref": "#/components/pathItems/ConsumerDeletePreview" },

    "/api/v1/clusters/{clusterId}/schemas/subjects/{subject}/mutations/register/preview": { "$ref": "#/components/pathItems/SchemaRegisterPreview" },
    "/api/v1/clusters/{clusterId}/schemas/subjects/{subject}/mutations/compatibility/preview": { "$ref": "#/components/pathItems/SchemaCompatibilityPreview" },
    "/api/v1/clusters/{clusterId}/schemas/mutations/compatibility/preview": { "$ref": "#/components/pathItems/SchemaGlobalCompatibilityPreview" },
    "/api/v1/clusters/{clusterId}/schemas/subjects/{subject}/mutations/delete/preview": { "$ref": "#/components/pathItems/SchemaDeletePreview" },
    ...
    "/api/v1/clusters/{clusterId}/connect/connectors/{connectorName}/mutations/create/preview": { "$ref": "#/components/pathItems/ConnectConfigurationPreview" },
    "/api/v1/clusters/{clusterId}/connect/connectors/{connectorName}/mutations/update/preview": { "$ref": "#/components/pathItems/ConnectConfigurationPreview" },
    "/api/v1/clusters/{clusterId}/connect/connectors/{connectorName}/mutations/control/preview": { "$ref": "#/components/pathItems/ConnectControlPreview" },
    "/api/v1/clusters/{clusterId}/connect/connectors/{connectorName}/mutations/delete/preview": { "$ref": "#/components/pathItems/ConnectDeletePreview" },
    ...
    "/api/v1/mutations/{operationId}/connect/execute": { "$ref": "#/components/pathItems/ExecuteWithoutMaterial" },
  ...
  "components": {
    ...
    "pathItems": {
      ...
      "TopicCreatePreview": { "post": { "tags": ["Topic administration"], "summary": "Preview topic creation", "parameters": [{ "$ref": "#/components/parameters/ClusterId" }, { "$ref": "#/components/parameters/TopicName" }, { "$ref": "#/components/parameters/IdempotencyKey" }, { "$ref": "#/components/parameters/CsrfHeader" }], "requestBody": { "required": true, "content": { "application/json": { "schema": { "$ref": "#/components/schemas/TopicCreateRequest" } } } }, "responses": { "201": { "$ref": "#/components/responses/MutationStatus" }, "200": { "$ref": "#/components/responses/MutationStatus" }, "400": { "$ref": "#/components/responses/Problem" }, "409": { "$ref": "#/components/responses/Problem" } } } },
      "TopicAlterPreview": { "post": { "tags": ["Topic administration"], "summary": "Preview allowlisted topic configuration alteration", "parameters": [{ "$ref": "#/components/parameters/ClusterId" }, { "$ref": "#/components/parameters/TopicName" }, { "$ref": "#/components/parameters/IdempotencyKey" }, { "$ref": "#/components/parameters/CsrfHeader" }], "requestBody": { "required": true, "content": { "application/json": { "schema": { "$ref": "#/components/schemas/TopicAlterRequest" } } } }, "responses": { "201": { "$ref": "#/components/responses/MutationStatus" }, "200": { "$ref": "#/components/responses/MutationStatus" }, "400": { "$ref": "#/components/responses/Problem" } } } },
      "TopicIncreasePartitionsPreview": { "post": { "tags": ["Topic administration"], "summary": "Preview partition increase", "parameters": [{ "$ref": "#/components/parameters/ClusterId" }, { "$ref": "#/components/parameters/TopicName" }, { "$ref": "#/components/parameters/IdempotencyKey" }, { "$ref": "#/components/parameters/CsrfHeader" }], "requestBody": { "required": true, "content": { "application/json": { "schema": { "$ref": "#/components/schemas/TopicIncreasePartitionsRequest" } } } }, "responses": { "201": { "$ref": "#/components/responses/MutationStatus" }, "200": { "$ref": "#/components/responses/MutationStatus" }, "400": { "$ref": "#/components/responses/Problem" } } } },
      "TopicDeletePreview": { "post": { "tags": ["Topic administration"], "summary": "Preview topic deletion", "parameters": [{ "$ref": "#/components/parameters/ClusterId" }, { "$ref": "#/components/parameters/TopicName" }, { "$ref": "#/components/parameters/IdempotencyKey" }, { "$ref": "#/components/parameters/CsrfHeader" }], "responses": { "201": { "$ref": "#/components/responses/MutationStatus" }, "200": { "$ref": "#/components/responses/MutationStatus" }, "403": { "$ref": "#/components/responses/Problem" }, "409": { "$ref": "#/components/responses/Problem" } } } },
      "ConsumerOffsetPreview": { "post": { "tags": ["Consumer administration"], "summary": "Preview finite consumer offset targets", "parameters": [{ "$ref": "#/components/parameters/ClusterId" }, { "$ref": "#/components/parameters/GroupId" }, { "$ref": "#/components/parameters/IdempotencyKey" }, { "$ref": "#/components/parameters/CsrfHeader" }], "requestBody": { "required": true, "content": { "application/json": { "schema": { "$ref": "#/components/schemas/ConsumerOffsetRequest" } } } }, "responses": { "201": { "$ref": "#/components/responses/MutationStatus" }, "200": { "$ref": "#/components/responses/MutationStatus" }, "400": { "$ref": "#/components/responses/Problem" }, "409": { "$ref": "#/components/responses/Problem" } } } },
      "ConsumerDeletePreview": { "post": { "tags": ["Consumer administration"], "summary": "Preview consumer group or committed-offset deletion", "parameters": [{ "$ref": "#/components/parameters/ClusterId" }, { "$ref": "#/components/parameters/GroupId" }, { "$ref": "#/components/parameters/IdempotencyKey" }, { "$ref": "#/components/parameters/CsrfHeader" }], "requestBody": { "required": true, "content": { "application/json": { "schema": { "$ref": "#/components/schemas/ConsumerDeleteRequest" } } } }, "responses": { "201": { "$ref": "#/components/responses/MutationStatus" }, "200": { "$ref": "#/components/responses/MutationStatus" }, "400": { "$ref": "#/components/responses/Problem" }, "409": { "$ref": "#/components/responses/Problem" } } } },
      "SchemaRegisterPreview": { "post": { "tags": ["Schema Registry"], "summary": "Preview schema registration", "parameters": [{ "$ref": "#/components/parameters/ClusterId" }, { "$ref": "#/components/parameters/Subject" }, { "$ref": "#/components/parameters/IdempotencyKey" }, { "$ref": "#/components/parameters/CsrfHeader" }], "requestBody": { "required": true, "content": { "application/json": { "schema": { "$ref": "#/components/schemas/SchemaRegistrationRequest" } } } }, "responses": { "201": { "$ref": "#/components/responses/MutationStatus" }, "200": { "$ref": "#/components/responses/MutationStatus" }, "400": { "$ref": "#/components/responses/Problem" } } } },
      "SchemaCompatibilityPreview": { "post": { "tags": ["Schema Registry"], "summary": "Preview subject compatibility mutation", "parameters": [{ "$ref": "#/components/parameters/ClusterId" }, { "$ref": "#/components/parameters/Subject" }, { "$ref": "#/components/parameters/IdempotencyKey" }, { "$ref": "#/components/parameters/CsrfHeader" }], "requestBody": { "required": true, "content": { "application/json": { "schema": { "$ref": "#/components/schemas/SchemaCompatibilityRequest" } } } }, "responses": { "201": { "$ref": "#/components/responses/MutationStatus" }, "200": { "$ref": "#/components/responses/MutationStatus" } } } },
      "SchemaGlobalCompatibilityPreview": { "post": { "tags": ["Schema Registry"], "summary": "Preview global compatibility mutation", "parameters": [{ "$ref": "#/components/parameters/ClusterId" }, { "$ref": "#/components/parameters/IdempotencyKey" }, { "$ref": "#/components/parameters/CsrfHeader" }], "requestBody": { "required": true, "content": { "application/json": { "schema": { "$ref": "#/components/schemas/SchemaCompatibilityRequest" } } } }, "responses": { "201": { "$ref": "#/components/responses/MutationStatus" }, "200": { "$ref": "#/components/responses/MutationStatus" } } } },
      "SchemaDeletePreview": { "post": { "tags": ["Schema Registry"], "summary": "Preview explicit schema subject/version deletion", "parameters": [{ "$ref": "#/components/parameters/ClusterId" }, { "$ref": "#/components/parameters/Subject" }, { "$ref": "#/components/parameters/IdempotencyKey" }, { "$ref": "#/components/parameters/CsrfHeader" }], "requestBody": { "required": true, "content": { "application/json": { "schema": { "$ref": "#/components/schemas/SchemaDeleteRequest" } } } }, "responses": { "201": { "$ref": "#/components/responses/MutationStatus" }, "200": { "$ref": "#/components/responses/MutationStatus" }, "409": { "$ref": "#/components/responses/Problem" } } } },
      "ConnectConfigurationPreview": { "post": { "tags": ["Kafka Connect"], "summary": "Preview connector create/update with bounded configuration", "parameters": [{ "$ref": "#/components/parameters/ClusterId" }, { "$ref": "#/components/parameters/ConnectorName" }, { "$ref": "#/components/parameters/IdempotencyKey" }, { "$ref": "#/components/parameters/CsrfHeader" }], "requestBody": { "required": true, "content": { "application/json": { "schema": { "$ref": "#/components/schemas/ConnectConfigurationRequest" } } } }, "responses": { "201": { "$ref": "#/components/responses/MutationStatus" }, "200": { "$ref": "#/components/responses/MutationStatus" }, "400": { "$ref": "#/components/responses/Problem" } } } },
      "ConnectControlPreview": { "post": { "tags": ["Kafka Connect"], "summary": "Preview pause/resume/restart connector or task", "parameters": [{ "$ref": "#/components/parameters/ClusterId" }, { "$ref": "#/components/parameters/ConnectorName" }, { "$ref": "#/components/parameters/IdempotencyKey" }, { "$ref": "#/components/parameters/CsrfHeader" }], "requestBody": { "required": true, "content": { "application/json": { "schema": { "$ref": "#/components/schemas/ConnectControlRequest" } } } }, "responses": { "201": { "$ref": "#/components/responses/MutationStatus" }, "200": { "$ref": "#/components/responses/MutationStatus" }, "400": { "$ref": "#/components/responses/Problem" } } } },
      "ConnectDeletePreview": { "post": { "tags": ["Kafka Connect"], "summary": "Preview connector deletion", "parameters": [{ "$ref": "#/components/parameters/ClusterId" }, { "$ref": "#/components/parameters/ConnectorName" }, { "$ref": "#/components/parameters/IdempotencyKey" }, { "$ref": "#/components/parameters/CsrfHeader" }], "responses": { "201": { "$ref": "#/components/responses/MutationStatus" }, "200": { "$ref": "#/components/responses/MutationStatus" }, "409": { "$ref": "#/components/responses/Problem" } } } }
    },
    "schemas": {
      ...
      "MutationStatus": { "type": "object", "required": ["operationId", "clusterId", "operationKind", "riskClass", "requiresExecutionMaterial", "state", "previewHash", "previewExpiresAtUtc", "version"], "properties": { "operationId": { "type": "string", "format": "uuid" }, "clusterId": { "type": "string" }, "operationKind": { "type": "string" }, "riskClass": { "type": "string", "enum": ["low", "moderate", "high", "critical"] }, "confirmationMode": { "type": "string", "enum": ["explicit", "typedTarget"] }, "requiresIndependentApproval": { "type": "boolean" }, "requiresExecutionMaterial": { "type": "boolean", "description": "True when execution requires request-scoped material to be re-submitted and digest-matched. No material digest or raw material is exposed." }, "state": { "type": "string" }, "previewHash": { "type": "string" }, "previewExpiresAtUtc": { "type": "string", "format": "date-time" }, "confirmationChallenge": { "type": ["string", "null"] }, "resultCode": { "type": ["string", "null"] }, "safeProviderEvidence": { "type": "object", "additionalProperties": { "type": "string" } }, "version": { "type": "integer", "format": "int64" }, "createdAtUtc": { "type": "string", "format": "date-time" }, "updatedAtUtc": { "type": "string", "format": "date-time" } }, "additionalProperties": false },
